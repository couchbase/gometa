...
var PREFIX_COMMIT_LOG_PATH = "/couchbase/cstore/commitlog"        // Directory prefix for commit log
var PREFIX_SERVER_CONFIG_PATH = "/couchbase/cstore/server/config" // Directory prefix for server config
var PATH_DELIMITER = "/"                                          // Path Delimiter
